    ...
    <div>
      <div className="">
        ...
        <div className="pt-36 px-10 mx-8">
          <h1 className="text-[40px] w-[750px] font-bold">
            From residential buildings to public buildings, offices and
            warehouses.
          </h1>
        </div>
        <div className="flex gap-28 mx-8 pt-36">
          <div className=" flex flex-col gap-28 px-20 pt-20 ">
            <div className="w-[460px] h-[500px] overflow-hidden hover:cursor-pointer">
              <img
                src={assets.project1}
                alt=""
              ...
              <div className=" hover:flex items-center relative bottom-[178px] left-[310px] gap-4 bg-white w-32 h-10 justify-center rounded-full group hidden">
        ...
        <div className="flex items-center gap-4 bg-black w-64 mx-[520px] mt-28 h-14 justify-center rounded-full group">
          <button className=" text-white group-hover:text-white">
            See more projects
          </button>
          <img
            src={assets.right}
